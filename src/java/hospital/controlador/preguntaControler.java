...
import hospital.modelo.tipoEstudio;
...
@ViewScoped
public class preguntaControler implements Serializable {
...
//--------------------
    ...
    public List<tipoEstudio> getListaCE() {
        return lCE;
    }

    public void setListaCE(List<tipoEstudio> lCE) {
        this.lCE = lCE;
    }
//-------
...
//-----
    ...
    public void setTipoEstudio(tipoEstudio oCE) {
        this.oCE = oCE;
    }
    //---
    ...
    //-----------
    //-----
    public preguntaControler() throws Exception {
        ...
        this.lCE = oCE.buscaTodos();

        oEstado = new estado();
        this.lEstado = new ArrayList<>();
        this.lEstado = oEstado.buscaTodos();

        oCiudad = new ciudad();
        this.lCiudad = new ArrayList<>();
        this.lCiudad = oCiudad.buscaTodos();
    }
