...
public class RecallQF extends AbstractQFSimpleStatisticBased {

    private static final String ID = "RecallQF";
	...
	double val = subgroupPositives / populationPositives; // TP-Rate
	// or
	// Recall
