...
public class InverseReciprocalQF implements IQualityFunction {
    ...
    @Override
    public String getID() {
	return "InverseReciprocalQF(" + innerFunction.getID() + ")";
    }

    @Override
    public String getName() {
	return "Inverse reciprocal (" + innerFunction.getName() + ")";
    }
	...
	return 1 / innerFunction.evaluate(subgroup);
    }
	...
	return new InverseReciprocalQF(innerFunction.clone());
    }
