...
/**
 * {@link Fp} considers the false positives of a target considering the current
 * subgroup.
 * 
 * @author Tobias Vogele
 */
public class Fp extends AbstractFormulaNumberPrimitive {
	...
	return new Double(((SGStatisticsBinary) data.getStatistics()).getFp());
    }
