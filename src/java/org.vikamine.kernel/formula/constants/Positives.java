...
/**
 *  {@link Positives} considers all positives (true + false positives) of a
 * target considering the current subgroup, i.e., the number of subgroup
 * instances containing the (boolean) target.
 * 
 * @author Tobias Vogele
 */
public class Positives extends AbstractFormulaNumberPrimitive {
	...
	return new Double(((SGStatisticsBinary) statistics).getPositives());
    }
