...
public class DeleteBestConditionByLevel extends DeleteBestConditionByLevel_Wrapper
{

    public String name = "DeleteBestConditionByLevel";
    ...
    public DeleteBestConditionByLevel (InstanceSet train, HashMap<String, String> params)
    {
        this.train = train;
        ...
        maxTree = Integer.parseInt(params.get("maxTree"));
