...
public class RandomForest extends RandomForest_Wrapper
{

    public String name = "RandomForest";
    ...
    public RandomForest (InstanceSet train, HashMap<String, String> params)
    {
        this.train = train;
