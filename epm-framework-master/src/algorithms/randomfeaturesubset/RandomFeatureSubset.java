 ...
 *********************************************************************
 */
package algorithms.randomfeaturesubset;
...
import PRFramework.Core.SupervisedClassifiers.EmergingPatterns.Miners.RandomFeatureSubsetMiner;
...
public class RandomFeatureSubset extends RandomFeatureSubset_Wrapper
{

    public String name = "RandomFeatureSubset";
    ...
    public RandomFeatureSubset (InstanceSet train, HashMap<String, String> params)
    {
        this.train = train;
        ...
        subsetSize = Integer.parseInt(params.get("subsetSize"));
        subsetPercent = Integer.parseInt(params.get("subsetPercent"));
    }
    ...
    public void mine ()
    {
        ...
        RandomFeatureSubsetMiner miner = new RandomFeatureSubsetMiner();
        ...
        miner.setSubsetSize(subsetSize);
        miner.setSubsetPercent(subsetPercent);
