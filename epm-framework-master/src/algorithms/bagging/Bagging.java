...
import PRFramework.Core.SupervisedClassifiers.EmergingPatterns.Miners.BaggingMiner;
...
public class Bagging extends Bagging_Wrapper
{

    public String name = "Bagging";
    ...
    public Bagging (InstanceSet train, HashMap<String, String> params)
    {
        this.train = train;
    ...
    public void mine ()
    {
        ...
        BaggingMiner miner = new BaggingMiner();
