...
public class DeleteBestCondition extends DeleteBestCondition_Wrapper
{

    public String name = "DeleteBestCondition";
    ...
    public DeleteBestCondition (InstanceSet train, HashMap<String, String> params)
    {
        this.train = train;
