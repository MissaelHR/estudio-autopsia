 ...
 *********************************************************************
 */
package algorithms.randomsplit;
...
import PRFramework.Core.SupervisedClassifiers.EmergingPatterns.Miners.RandomSplitMiner;
...
public class RandomSplit extends RandomSplit_Wrapper
{

    public String name = "RandomSplit";
    ...
    public RandomSplit (InstanceSet train, HashMap<String, String> params)
    {
        this.train = train;
        ...
        bestKToSearch = Integer.parseInt(params.get("bestKToSearch"));
    }
    ...
    public void mine ()
    {
        ...
        RandomSplitMiner miner = new RandomSplitMiner();
        ...
        miner.setBestKToSearch(bestKToSearch);
